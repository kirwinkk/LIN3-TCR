...
ki = LINETCR.LINE()
ki.login(token="EkJCaGYV5ph857d99nD4.WjRz5oW1/nfIsExC/cMSza.O7Y6hl+gHpq2pAxDI8/1P+NrFoAV36GgKi7vHMD7F/E=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EkHw1Z2Er4hFOAd0hLu8.iarQyHUgknIRni5Recj+Ea.HF284zgT84HWsW4SMcWNSK4/KZ6Jzk9QQiYKuXgLUgY=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="Ek1n24GiD4H35Y3kFhI1.qmf+mG4qg58AVj7ARoBTuq.2ffjllqk8pwCNiVOkqKhNjlHBkTCVziiu7iwDc+Wi1A=")
kc.loginResult()

kd = LINETCR.LINE()
kd.login(token="Ek8xhx7IXg51dUDyb7nd.eem+p7zyhJGXULW/YtGNpq.zZDEQCDpO/7rQ82beaWCIa8iQ0NiGBC2AwvDGP0PpKk=")
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token="Ek6WPWf80uj1xhXTpZi0.3d81No0uyJfmd61BOYIYCa.JgoYOcaVy1OWtxcbZ9EoWietBaG3sMZuIGAG/fu8twU=")
ke.loginResult()

kf = LINETCR.LINE()
kf.login(token="EkhUm2Gd4BRmFQLFTrM7.TvrivhCzmMUw1JoimPbQvW.Bx5QuD+j9PSddE3at9WxK0nUD/rDAJJSSRwWjsrpOgc=")
kf.loginResult()
...
#-----------------------------------------------
                ...
                if msg.from_ in admin:
                    ...
                    kd.sendText(msg.to,"ℬᎶ戦神Bot降臨~")
                    ke.sendText(msg.to,"ℬᎶ戦神Bot降臨~")
                    kf.sendText(msg.to,"ℬᎶ戦神Bot降臨~")
                    targets = []
                    for g in gs.members:
...
#-----------------------------------------------
		...
		cl.sendText(msg.to,"ℬᎶ戦神Bot主機")
                ki.sendText(msg.to,"ℬᎶ戦神Bot")
                kk.sendText(msg.to,"ℬᎶ戦神Bot")
                kc.sendText(msg.to,"ℬᎶ戦神Bot")
                kd.sendText(msg.to,"ℬᎶ戦神Bot")
                ke.sendText(msg.to,"ℬᎶ戦神Bot")
                kf.sendText(msg.to,"ℬᎶ戦神Bot")
#-----------------------------------------------
