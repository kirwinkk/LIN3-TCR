...
def nameUpdate():
    while True:
		...
		profile = a2.getProfile()
                ...
                profile.displayName = "台湾戦神☆Protect-kickerA"
                a1.updateProfile(profile)
		profile.displayName = "台湾戦神☆Protect-kickerB"
                a2.updateProfile(profile)
		profile.displayName = "台湾戦神☆Protect-kickerC"
                a3.updateProfile(profile)
		profile.displayName = "台湾戦神☆Protect-kickerD"
                a4.updateProfile(profile)
		profile.displayName = "台湾戦神☆Protect-kickerE"
                a5.updateProfile(profile)
		profile.displayName = "台湾戦神☆Protect-kickerF"
                a6.updateProfile(profile)
		profile.displayName = "台湾戦神☆Protect-kickerG"
                a7.updateProfile(profile)
		profile.displayName = "台湾戦神☆Protect-kickerH"
                a8.updateProfile(profile)
		profile.displayName = "台湾戦神☆Protect-kickerI"
                a9.updateProfile(profile)
		profile.displayName = "台湾戦神☆Protect-kickerJ"
                a10.updateProfile(profile)
		profile.displayName = "台湾戦神☆Protect-kickerK"
                a15.updateProfile(profile)
		profile.displayName = "台湾戦神☆Protect-kickerL"
                a16.updateProfile(profile)
		profile.displayName = "台湾戦神☆Protect-kickerM"
                a17.updateProfile(profile)
		profile.displayName = "台湾戦神☆Protect-kickerN"
                a18.updateProfile(profile)
		profile.displayName = "台湾戦神☆Protect-kickerO"
                a19.updateProfile(profile)
		profile.displayName = "台湾戦神☆Protect-kickerP"
                a20.updateProfile(profile)
		profile.displayName = "台湾戦神☆Protect-kickerQ"
                a21.updateProfile(profile)
		profile.displayName = "台湾戦神☆Protect-kickerR"
                a22.updateProfile(profile)
		profile.displayName = "台湾戦神☆Protect-kickerS"
...
def autolike():
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						time.sleep(2)
						a15.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
						a15.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"台湾戦神☆style\n" + datetime.datetime.today().strftime('%Y-%m-%d %H:%M:%S.%f'))
						a16.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
						a16.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"台湾戦神☆style\n" + datetime.datetime.today().strftime('%Y-%m-%d %H:%M:%S.%f'))
						a17.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
						a17.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"台湾戦神☆style\n" + datetime.datetime.today().strftime('%Y-%m-%d %H:%M:%S.%f'))
						a18.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
						a18.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"台湾戦神☆style\n" + datetime.datetime.today().strftime('%Y-%m-%d %H:%M:%S.%f'))
						a19.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
						a19.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"台湾戦神☆style\n" + datetime.datetime.today().strftime('%Y-%m-%d %H:%M:%S.%f'))
						a20.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
						a20.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"台湾戦神☆style\n" + datetime.datetime.today().strftime('%Y-%m-%d %H:%M:%S.%f'))
						a21.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
						a21.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"台湾戦神☆style\n" + datetime.datetime.today().strftime('%Y-%m-%d %H:%M:%S.%f'))
						a22.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
						a22.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"台湾戦神☆style\n" + datetime.datetime.today().strftime('%Y-%m-%d %H:%M:%S.%f'))
						a23.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
						a23.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"台湾戦神☆style\n" + datetime.datetime.today().strftime('%Y-%m-%d %H:%M:%S.%f'))
					except:
							pass
				else:
						pass
			time.sleep(10)
thread4 = threading.Thread(target=autolike)
thread4.daemon = True
thread4.start()
