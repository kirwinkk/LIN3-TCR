...
ki17 = LINETCR.LINE()
ki17.login(token="EkrlaNcDB0FZsM6didP1.qmf+mG4qg58AVj7ARoBTuq.TNqTDoqvlwBk7QNjWohphJUqpTfkz4tZuVizpnYAtck=")
ki17.loginResult()

ki18 = LINETCR.LINE()
ki18.login(token="EkOfaBLUVE3ItDceVdL5.gZZJX7/7XFs18VBE0wUJPq.GXafP3x4VpWtK0v3XxAHSvZVuuPirT0b/gZzKek2eY0=")
ki18.loginResult()
reload(sys)
