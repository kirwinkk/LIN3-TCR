...
def autolike():
        hasil = cl.activity
        if hasil['result']['posts']['postInfo']['liked'] == False:
          try:
            ki.like(hasil['result']['posts']['userInfo']['mid'],hasil['result']['posts']['postInfo']['postId'],likeType=1001)
            ki.comment(hasil['result']['posts']['userInfo']['mid'],hasil['result']['posts']['postInfo']['postId'],wait["comment"])
            print "Like"
          except:
            pass
