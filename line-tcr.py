...
cl = LINETCR.LINE()
cl.login(token="EmmKzE0LtZnZsGQoP4Ia.UTmR7BiztHSd6UxzLKVgkG.xrrDxCPzkbGEyvc6znpypaHAivwy40R1f8mlKP08hiM=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Em41N9p5vaEtMpAddqz4.ppJ5m2rtOITuKMPVpp2Kza.q5zhwP3nDi7pgqAG1YWce928WxPcNBcvqdEQdbS7rUY=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="Emllq2opZT2mH5qLrrdd.y5uKOl5vkdH88JG96gA/3q.yu9EcjVPabbbXQsWSbhCHK5eGjr1EAYUAdgwwGa+cOo=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EmlSCvogqMtAh11r6tsa.GiTq6xq+GUWzjgNJq9FLwG.+sn5SgmUFCym0QXQRFCjBlglj776/6Z/c6qbrZ4il4c=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EmC44aeLWBpn2KlZ22Jf.9GY0amPdY9QBs4xGRc6ghW.RU5DOI1xzzT1tgtLqDRT0BPXkxw1iDqGCrDRmzeKMLw=")
ki4.loginResult()
...
Bots=[mid,kimid,ki2mid,ki3mid,ki4mid,"uc216d8664c4e1f43772c98b1b0b8956e","u8dc2983d2e3183303bc466f3283d44d8"]
Botttt=[mid,kimid,ki2mid,ki3mid,ki4mid]
	...
	if op.type == 17:
		...
		cl.sendText(msg.to,"[戦神SelfBOT]\n已讀設定OK")
		  ...
		  if msg.to in wait2['readPoint']:
	            ...
	            ki.sendText(msg.to,"[戦神SelfBOT已讀機]\n\n%s"  % (wait2['readMember'][msg.to]))
	          else:
