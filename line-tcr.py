...
ℬᎶ戦神Bot 作者:http://line.me/ti/p/4-ZKcjagH0
"""
helo=""
     ...
     for zx in range(0,50):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:    
            ...
            cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"ℬᎶ戦神Bot 作者:http://line.me/ti/p/4-ZKcjagH0")
            ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"ℬᎶ戦神Bot 作者:http://line.me/ti/p/4-ZKcjagH0")
            ki1.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"ℬᎶ戦神Bot 作者:http://line.me/ti/p/4-ZKcjagH0")
            ki2.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"ℬᎶ戦神Bot 作者:http://line.me/ti/p/4-ZKcjagH0")
            ki3.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"ℬᎶ戦神Bot 作者:http://line.me/ti/p/4-ZKcjagH0")
            ki4.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"ℬᎶ戦神Bot 作者:http://line.me/ti/p/4-ZKcjagH0")
            ki5.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"ℬᎶ戦神Bot 作者:http://line.me/ti/p/4-ZKcjagH0")
            ki6.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"ℬᎶ戦神Bot 作者:http://line.me/ti/p/4-ZKcjagH0")
            print "Like"
          except:
            pass
        else:
