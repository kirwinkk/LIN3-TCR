...
[Sp]→反應速度
[Joinon/off]→自動入群開關
[Protecton/off]→踢人保護開關
[Namelockon/off]→群名保護開關
...
def bot(op):
    try:
		...
		Group = msg.to
                md = ""
		if Group in wait["pkick"]: md+="踢人保護:開啟\n"
                else: md +="踢人保護:關閉\n"
                if Group in wait["purl"]: md+="網址保護:開啟\n"
                else: md +="網址保護:關閉\n"
                if Group in wait["pname"]: md+="群名保護:開啟\n"
                else: md +="群名保護:關閉\n"
                if Group in wait["pinvite"]: md+="禁邀保護:開啟"
                else: md +="禁邀保護:關閉"
