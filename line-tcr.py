        ...
        if op.type == 25:
			...
			cl.sendText(msg.to,"此機器作者↓")
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    cl.sendText(msg.to,"已改名為:" + string + "~")
#---------------------------------------------------------
...
#--------------------------------------------------------
                ...
                if wait["protect"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"保護開啟")
            elif msg.text.lower() == 'Urlprotecton':
                if wait["linkprotect"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"網址保護開啟")
            elif msg.text.lower() == 'Inviteprotecton':
                if wait["inviteprotect"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"招待保護開啟")
            elif msg.text.lower() == 'Cancelprotecton':
                ...
                if wait["leaveRoom"] == True: md+="自動離開副本:on 􀜁􀄯􏿿\n"
                else: md+="自動離開副本:關閉\n"
                ...
                cl.sendMessage(msg + datetime.datetime.today().strftime('%H:%M:%S'))
...
#-----------------------------------------------------------
                ...
                if msg.toType == 2:
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    klist=[ki,ki1,ki2,ki3,ki4,ki5,ki6]
...
#-----------------------------------------------
                        ...
                        G.preventJoinByTicket(G)
                        ki.updateGroup(G)
                        ki.sendText(msg.to,"已加入"  +  str(ginfo.name)  + "~~")
#-----------------------------------------------
     ...
     for zx in range(0,50):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:    
            ...
            cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"ℬᎶ戦神Bot")
            print "Like"
          except:
            pass
        else:
