...
def bot(op):
    try:
		...
		if msg.from_ in staff:
            ...
            elif msg.text in ["/bgbot","/BGbot","/BGbot2"]:
		if msg.from_ in staff:
...
def nameUpdate():
    while True:
		...
		profile.displayName = "Protection[B]"
		ki.updateProfile(profile)
		profile = ki2.getProfile()
		profile.displayName = "Protection[C]"
		...
		profile.displayName = "Protection[M]"
		ki8.updateProfile(profile)
		profile = ki9.getProfile()
		profile.displayName = "Protection[Q]"
