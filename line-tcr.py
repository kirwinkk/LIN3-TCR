...
ki15 = LINETCR.LINE()
ki15.login(token="EnyolAj0C6FSWoljQCae.WHByzKXoh0n3ljIXSlIvBG.RwDX+6JdCfhbWGQSzcwVHzrFumSChTTmJp73hAY7c5A=")
ki15.loginResult()
...
admin = [mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,ki6mid,ki7mid,ki8mid,ki9mid,ki15mid,"u82d9a9f4133dabb9686598e88413e5d7","uddf9714006a1010bb6551fc107f52390","ua1d924caa58666ee73d0625ca036a1b1","u8dc2983d2e3183303bc466f3283d44d8","uc216d8664c4e1f43772c98b1b0b8956e","ubecd98a04cbf74a830b6c95b67bd6b74","u40c17f320e101b9f1abc9edaace6ed51","uef3dc2c514c550e1935b5b679dac38f6","u7a1c4338e6342bbbc33d9fa3c295b7d4","uad3b11a07372a5955ba75dc1caadeed8","u4ab4047d824385456811a2fe93c95382","u40c17f320e101b9f1abc9edaace6ed51","u8a627a2ff2ed54bcdd6c3b52f2b9691b","u96fd5925ecab120ea325511f4b53db11","ua0c6c9175efd94a9551338c72d6a7d17","u3d860a1bb50f8a536653b4940aa41bbf","u8be7a9504b9185ba75234f2f8110697b"]
staff = []
staff2 = []
staff3 = []
staff4 = []
staff5 = []
staff6 = ["uc216d8664c4e1f43772c98b1b0b8956e","uddf9714006a1010bb6551fc107f52390","ubecd98a04cbf74a830b6c95b67bd6b74","u82d9a9f4133dabb9686598e88413e5d7","u8dc2983d2e3183303bc466f3283d44d8","ua1d924caa58666ee73d0625ca036a1b1"]
bgbot = ["u27a2e1c6d2067d3c644c3a04efc00b80","ua3f3e627b3f06be52532e5b6f6d328cf","uddf9714006a1010bb6551fc107f52390","u82d9a9f4133dabb9686598e88413e5d7"]
...
def bot(op):
    try:
        ...
        if op.type == 26:
			...
			if msg.contentMetadata["mid"] in wait["blacklist"]:
			   if msg.contentMetadata["mid"] not in staff+staff2+staff3+staff4+staff5+staff6:
				u="Level.0"
			   if msg.contentMetadata["mid"] in staff:
				u="Level.1"
			   if msg.contentMetadata["mid"] in staff2:
				u="Level.2"
			   if msg.contentMetadata["mid"] in staff3:
				u="Level.3"
			   if msg.contentMetadata["mid"] in staff4:
				u="Level.4"
			   if msg.contentMetadata["mid"] in staff5:
				u="Level.5"
			   if msg.contentMetadata["mid"] in staff6:
				u="Level.6"
			   try:
		...
		gid = ki9.getGroupIdsJoined()
                for i in gid:
		    cl.sendText(i,"作者:戦神 Made In Taiwan\nhttps://line.me/R/ti/p/%40cld3625n")
                    cl.leaveGroup(i)
                    ki.leaveGroup(i)
                    ki2.leaveGroup(i)
                    ki3.leaveGroup(i)
