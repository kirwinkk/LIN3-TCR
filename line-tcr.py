...
ki = LINETCR.LINE()
ki.login(token="ElnO5bNG0LdWHM1lcVS0.Sz0l2hUZyDHZIRqY1ReQea.zGHUhmqxqPgy+U6lrJvRltytsZdmE2DUbEvQ0O4FIgM=")
ki.loginResult()
...
ki3 = LINETCR.LINE()
ki3.login(token="ElJXRXnXPNAjmOvNBxv7.hOpNr4wbx5KMeFmQXBc5TW./pl87Q/Wr+UOKYNfGHGhQNnpZ3EWqWc6njo2bgr4A3g=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="Ela4iQjLMmWhXL3aIWf5.1UlbJo7AaQIIh43vnZEmvq.pPK1IbCzUe6KWMspgg8Lpn2nuaIupiMbhT9ES/ak5JM=")
ki4.loginResult()
...
ki6 = LINETCR.LINE()
ki6.login(token="El3K6C9QyHVdhFoAyIa7.jvd7T5r6TSHa3VMqwSkOfW.us5C1DGhPj7r01duuameWYe3Y0YTOItCMnau7nv8FXk=")
ki6.loginResult()

ki7 = LINETCR.LINE()
ki7.login(token="ElSx7EZx0N5f57VCYFo8.TzpFZMXsDV4G9tO87QsIsa.c6FLvd/TFOlEL6DC9J2AF/kLkoXbbDIoDOr3cxHv7dk=")
ki7.loginResult()
...
ki9 = LINETCR.LINE()
ki9.login(token="ElbhnySShZMghp3k6XG8.P9FyIUrUbeAmcjZnfpjX6a.METG+Pqt/AnOOfK8MuawG8yBnMbrDmi6dhcBj/LzeA4=")
ki9.loginResult()
...
staff2 = ["uc216d8664c4e1f43772c98b1b0b8956e"]
staff3 = ["uc216d8664c4e1f43772c98b1b0b8956e"]
staff4 = ["uc216d8664c4e1f43772c98b1b0b8956e"]
staff5 = ["uc216d8664c4e1f43772c98b1b0b8956e"]
...
def bot(op):
    try:
        ...
        if op.type == 13:
           if mid in op.param3:
		if op.param2 in wait["stafflist2"] + wait["stafflist3"] + wait["stafflist4"] + wait["stafflist5"] + admin:
        ...
        if op.type == 13:
            if op.param2 not in wait["stafflist2"] + wait["stafflist3"] + wait["stafflist4"] + wait["stafflist5"] + admin:
		Inviter = op.param3.replace("",',')
                InviterX = Inviter.split(",")
                matched_list = []
                for tag in wait["blacklist"]:
        ...
        if op.type == 26:
            msg = op.message
            if msg.contentType == 13:
                if wait["wstafflist"] == True:
                    if msg.contentMetadata["mid"] in wait["stafflist"]:
                        ki3.sendText(msg.to,msg.contentMetadata["displayName"] + " 已提升權限至Lv.1")
                        wait["wstafflist"] = False
                    else:
                        wait["stafflist"][msg.contentMetadata["mid"]] = True
                        wait["wstafflist"] = False
                        ki3.sendText(msg.to,msg.contentMetadata["displayName"] + " 已提升權限至Lv.1")
                elif wait["dstafflist"] == True:
                    if msg.contentMetadata["mid"] in wait["stafflist"]:
                        del wait["stafflist"][msg.contentMetadata["mid"]]
                        ki4.sendText(msg.to,msg.contentMetadata["displayName"] + " 已解除Lv.1權限")
                        wait["dstafflist"] = False
                    else:
                        wait["dstafflist"] = False
                        ki4.sendText(msg.to,msg.contentMetadata["displayName"] + " 已解除Lv.1權限")
        ...
        if op.type == 26:
            msg = op.message
            if msg.contentType == 13:
                if wait["wstafflist2"] == True:
                    if msg.contentMetadata["mid"] in wait["stafflist2"]:
                        ki3.sendText(msg.to,msg.contentMetadata["displayName"] + " 已提升權限至Lv.2")
                        wait["wstafflist2"] = False
                    else:
                        wait["stafflist2"][msg.contentMetadata["mid"]] = True
                        wait["wstafflist2"] = False
                        ki3.sendText(msg.to,msg.contentMetadata["displayName"] + " 已提升權限至Lv.2")
                elif wait["dstafflist2"] == True:
                    if msg.contentMetadata["mid"] in wait["stafflist2"]:
                        del wait["stafflist2"][msg.contentMetadata["mid"]]
                        ki4.sendText(msg.to,msg.contentMetadata["displayName"] + " 已解除Lv.2權限")
                        wait["dstafflist2"] = False
                    else:
                        wait["dstafflist2"] = False
                        ki4.sendText(msg.to,msg.contentMetadata["displayName"] + " 已解除Lv.2權限")
        ...
        if op.type == 26:
            msg = op.message
            if msg.contentType == 13:
                if wait["wstafflist3"] == True:
                    if msg.contentMetadata["mid"] in wait["stafflist3"]:
                        ki3.sendText(msg.to,msg.contentMetadata["displayName"] + " 已提升權限至Lv.3")
                        wait["wstafflist3"] = False
                    else:
                        wait["stafflist3"][msg.contentMetadata["mid"]] = True
                        wait["wstafflist3"] = False
                        ki3.sendText(msg.to,msg.contentMetadata["displayName"] + " 已提升權限至Lv.3")
                elif wait["dstafflist3"] == True:
                    if msg.contentMetadata["mid"] in wait["stafflist3"]:
                        del wait["stafflist3"][msg.contentMetadata["mid"]]
                        ki4.sendText(msg.to,msg.contentMetadata["displayName"] + " 已解除Lv.3權限")
                        wait["dstafflist3"] = False
                    else:
                        wait["dstafflist3"] = False
                        ki4.sendText(msg.to,msg.contentMetadata["displayName"] + " 已解除Lv.3權限")
        ...
        if op.type == 26:
            msg = op.message
            if msg.contentType == 13:
                if wait["wstafflist4"] == True:
                    if msg.contentMetadata["mid"] in wait["stafflist4"]:
                        ki3.sendText(msg.to,msg.contentMetadata["displayName"] + " 已提升權限至Lv.4")
                        wait["wstafflist4"] = False
                    else:
                        wait["stafflist4"][msg.contentMetadata["mid"]] = True
                        wait["wstafflist4"] = False
                        ki3.sendText(msg.to,msg.contentMetadata["displayName"] + " 已提升權限至Lv.4")
                elif wait["dstafflist4"] == True:
                    if msg.contentMetadata["mid"] in wait["stafflist4"]:
                        del wait["stafflist4"][msg.contentMetadata["mid"]]
                        ki4.sendText(msg.to,msg.contentMetadata["displayName"] + " 已解除Lv.4權限")
                        wait["dstafflist4"] = False
                    else:
                        wait["dstafflist4"] = False
                        ki4.sendText(msg.to,msg.contentMetadata["displayName"] + " 已解除Lv.4權限")
        ...
        if op.type == 26:
            msg = op.message
            if msg.contentType == 13:
                if wait["wstafflist5"] == True:
                    if msg.contentMetadata["mid"] in wait["stafflist5"]:
                        ki3.sendText(msg.to,msg.contentMetadata["displayName"] + " 已提升權限至Lv.5")
                        wait["wstafflist5"] = False
                    else:
                        wait["stafflist5"][msg.contentMetadata["mid"]] = True
                        wait["wstafflist5"] = False
                        ki3.sendText(msg.to,msg.contentMetadata["displayName"] + " 已提升權限至Lv.5")
                elif wait["dstafflist5"] == True:
                    if msg.contentMetadata["mid"] in wait["stafflist"]:
                        del wait["stafflist5"][msg.contentMetadata["mid"]]
                        ki4.sendText(msg.to,msg.contentMetadata["displayName"] + " 已解除Lv.5權限")
                        wait["dstafflist5"] = False
                    else:
                        wait["dstafflist5"] = False
                        ki4.sendText(msg.to,msg.contentMetadata["displayName"] + " 已解除Lv.5權限")
			...
			ki9.leaveGroup(msg.to)
                ...
                if msg.from_ in admin:
                   ...
                   for target in targets:
                            try:
                                wait["stafflist"][target] = True
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["stafflist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                ki.sendText(msg.to,"已提升權限Lv.1")
                            except:
                                pass
                ...
                if msg.from_ in admin:
                   ...
                   for target in targets:
                            try:
                                wait["stafflist2"][target] = True
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["stafflist2"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                ki.sendText(msg.to,"已提升權限Lv.2")
                            except:
                                pass
                ...
                if msg.from_ in admin:
                   ...
                   for target in targets:
                            try:
                                wait["stafflist3"][target] = True
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["stafflist3"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                ki.sendText(msg.to,"已提升權限Lv.3")
                            except:
                                pass
                ...
                if msg.from_ in admin:
                   ...
                   for target in targets:
                            try:
                                wait["stafflist4"][target] = True
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["stafflist4"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                ki.sendText(msg.to,"已提升權限Lv.4")
                            except:
                                pass
                ...
                if msg.from_ in admin:
                   ...
                   for target in targets:
                            try:
                                wait["stafflist5"][target] = True
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["stafflist5"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                ki.sendText(msg.to,"已提升權限Lv.5")
                            except:
                                pass
