...
ki9 = LINETCR.LINE()
ki9.login(token="EjIoPnpBQO3ZK8B4HBU4.IvO4AeCFxrZCluZHngV2La.WUV2IHJ4Avxc8OPhiZHCWTWQLwHbrY6IerJXXKYLxxY=")
ki9.loginResult()

ki10 = LINETCR.LINE()
ki10.login(token="EjafLAVb95rkhgaubvPc.Un//7rQ3bwRb7wltBzdpla.+BthNs6PyQkTwMv0XxVF1fHy7ja5STW9EJlUBioizwo=")
ki10.loginResult()

ki11 = LINETCR.LINE()
ki11.login(token="EjWL4tCMarukslEEZKVa.J/L6Of4mcp51P+ezo746kG.tGFeynCLh2w787CfOs7HrtStTXKKma5qrusaWtNnoEQ=")
ki11.loginResult()

ki12 = LINETCR.LINE()
ki12.login(token="EjNTxvWl459v8afwPfkf.8kRxNMFmz0FgIQ1s28SNtW.6cFwa4rbvpT4VSbl3Jat9c8+LbSrrLHmYyIBUoUL03g=")
ki12.loginResult()

ki13 = LINETCR.LINE()
ki13.login(token="EjExi2Bh8CmPgpl2gOx7.EOF2N1lkKEbt8pZaTxU+PW.cJo27utM9LlX6GFyHf4z8dzMPOU0NsM5xpCQqJnGDPQ=")
ki13.loginResult()
