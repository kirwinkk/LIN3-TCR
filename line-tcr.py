...
ki9 = LINETCR.LINE()
ki9.login(token="EkPpQ9srzYkJvI4MjA94.cLUYBOWJ3l74Y0id8v8OXa.gNiYvN8/kgrDRLndeHyB8LbZRDW6iS74llF0S6vx1ZQ=")
ki9.loginResult()


ki10 = LINETCR.LINE()
ki10.login(token="EkSuazYXrX9MUmQrqnvb.JGXi37xKf5CbOC+nc/LtgW.khGEAlboJI1eag04hIc7036RMz9bXSWWDis6yenczOY=")
ki10.loginResult()

ki11 = LINETCR.LINE()
ki11.login(token="Ek3OYxaByvgnrvrZGCOc.a5njsIjkYmhnIxHDMAEHBa.OHLH1yI9feT4JExNdeU22jVLQptyVxarfQ1B/rgA/Lk=")
ki11.loginResult()

ki12 = LINETCR.LINE()
ki12.login(token="EkENC4R1oazaYwD3IEde.anot7ok1CmMlkurtH8BKxG.cCsFQzxbtd2HxKcIeH7BFA9X01yGwKNcIAZWuVs4p+s=")
ki12.loginResult()

ki13 = LINETCR.LINE()
ki13.login(token="EkBFUH2KRvooCziIe3K9.sZWYkriJsJf80xBKZDkbsq.kadwbKtdlV2Sv/yfxtAmdFHm3k0ymvMd68ZT98tM5Z0=")
ki13.loginResult()

ki14 = LINETCR.LINE()
ki14.login(token="EkGIlVSPEV2reF9yJPV5.YmK3RE2Gh7r1rsdbSBQibq.tKU1hvspJfPh6q1vCZfK8M8+U0/B8bWA3FsxqPS7pMM=")
ki14.loginResult()

ki15 = LINETCR.LINE()
ki15.login(token="EkRQbZZErjrx5uujDyza.84BapPm+V0nuPZ1PkEq6/G.V3aSBbMrbByVhVmOx9yrMp4S7FTJqw6cetH43/pOLEA=")
ki15.loginResult()

ki16 = LINETCR.LINE()
ki16.login(token="EkZvZ7Hlj7m84MOx8yI1.O00VsLTlmX6iq84iusWZ4q.ScFSA8A8Qsbfp5hguvZI5/MZ3JkFwkM9PIvGyqC7Pi4=")
ki16.loginResult()

ki17 = LINETCR.LINE()
ki17.login(token="EkpaxWwnqie6I5luusg7.St9fkz8GgIrWBhX+pEuGrW.Nho5QtsDAstF7T2MmUqC3ogYFUW7nw9yiu58tEARJZQ=")
ki17.loginResult()

ki18 = LINETCR.LINE()
ki18.login(token="EkeaUw67d8l1ksWaRIf9.VPm++2MfGJebW2j6OM3Qcq.N8RkI8fzMpTI6SkoxX1gg/yZcvpOp2GmCubdVUizk/I=")
ki18.loginResult()
reload(sys)
...
#--------------------------------------------------------
            elif "10names:" in msg.text:
                string = msg.text.replace("10names:","")
                if len(string.decode('utf-8')) <= 30:
                    profile = ki10.getProfile()
                    profile.displayName = string
                    ki10.updateProfile(profile)
...
#--------------------------------------------------------
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki15.updateProfile(profile)
                    ki15.sendText(msg.to,"已改名為:" + string + "~")
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki16.updateProfile(profile)
                    ki16.sendText(msg.to,"已改名為:" + string + "~")
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki17.updateProfile(profile)
                    ki17.sendText(msg.to,"已改名為:" + string + "~")
                ...
                if len(string.decode('utf-8')) <= 30:
                    ...
                    profile.displayName = string
                    ki18.updateProfile(profile)
                    ki18.sendText(msg.to,"已改名為:" + string + "~")
#--------------------------------------------------------
...
""")
                ki2.sendText(msg.to,"""ℬᎶ戦神Bot2\n\nkey Only Kicker\n\n[Kb2 in]\n[2Aditname:]\n[B Cancel]\n[kick @]\n[Ban @]\n[kill]\n[BotChat]\n[Respons]\n[Kb2 Gift]\n[Bot2bye]
""")
                ki3.sendText(msg.to,"""ℬᎶ戦神Bot3\n\nkey Only Kicker\n\n[Kb3 in]\n[3Aditname:]\n[B Cancel]\n[kick @]\n[Ban @]\n[kill]\n[BotChat]\n[Respons]\n[Kb3 Gift]\n[Bot3bye]
""")
                ki4.sendText(msg.to,"""ℬᎶ戦神Bot4\n\nkey Only Kicker\n\n[Kb4 in]\n[4Aditname:]\n[B Cancel]\n[kick @]\n[Ban @]\n[kill]\n[BotChat]\n[Respons]\n[Kb4 Gift]\n[Bot4bye]
""")
                ki5.sendText(msg.to,"""ℬᎶ戦神Bot5\n\nkey Only Kicker\n\n[Kb5 in]\n[5Aditname:]\n[B Cancel]\n[kick @]\n[Ban @]\n[kill]\n[BotChat]\n[Respons]\n[Kb5 Gift]\n[Bot5bye]
""")
                ki6.sendText(msg.to,"""ℬᎶ戦神Bot6\n\nkey Only Kicker\n\n[Kb6 in]\n[6Aditname:]\n[B Cancel]\n[kick @]\n[Ban @]\n[kill]\n[BotChat]\n[Respons]\n[Kb6 Gift]\n[Bot6bye]
""")
#-----------------------------------------------
