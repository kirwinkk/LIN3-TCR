...
ki = LINETCR.LINE()
ki.login(token="Ek5wMqt6tyVsBgaXIMJ4.WjRz5oW1/nfIsExC/cMSza.LojIUZZ9d/VRceEWCYtOUkfPxYIJm9/WQoWb+IftcQg=")
ki.loginResult()
...
ki5 = LINETCR.LINE()
ki5.login(token="EkukzJ7gWt0PnbcWKv33.MG8BtWFbb+oGXed0Fa9qWW.qZYhkFJC8pm3HM8aHJkga4YQot2OfFpBIrx7PydTNxk=")
ki5.loginResult()
...
ki7 = LINETCR.LINE()
ki7.login(token="Ekx78FlZHpDRydU5A5W0.bUWp6DHUJ5cshMkl5m0Aia.w9MLieeRDl2xBIa1ZbLI9F05sv7V3xdDA0PX6BaR8u0=")
ki7.loginResult()

ki8 = LINETCR.LINE()
ki8.login(token="Ek8lJbO1TdtJ7IU59b9e.anot7ok1CmMlkurtH8BKxG.adpzKav+kBaG/ZR3T3184RjLfRC0LSqAHy8t+ekGDns=")
ki8.loginResult()

ki9 = LINETCR.LINE()
ki9.login(token=" El2e4tTG29CjOqKMB0h8.w0WR2OKO/canEpl7cVYAMa.6GMKEhlAD0dzu6xu8x4Wl+fSApjtztJ2saUz+UzRWnc=")
ki9.loginResult()

ki10 = LINETCR.LINE()
ki10.login(token="EkFxBRmXkbP3J3mAZPM3.vy5yDd4vkH13GPwq582miW.yquPVYw1Q9FjnJjTEECpQ3AU0xiNsriNsUFWw0B2TVA=")
ki10.loginResult()
...
def nameUpdate():
    while True:
		...
		profile = ki2.getProfile()
		profile.displayName = "戦神☆1"
		ki2.updateProfile(profile)
		profile = ki3.getProfile()
		profile.displayName = "戦神☆2"
		ki3.updateProfile(profile)
		profile = ki4.getProfile()
		profile.displayName = "戦神☆3"
		ki4.updateProfile(profile)
		profile = ki5.getProfile()
		profile.displayName = "戦神☆4"
		ki5.updateProfile(profile)
		profile = ki6.getProfile()
		profile.displayName = "戦神☆5"
		ki6.updateProfile(profile)
		profile = ki7.getProfile()
		profile.displayName = "戦神☆6"
		ki7.updateProfile(profile)
		profile = ki8.getProfile()
		profile.displayName = "戦神☆7"
		ki8.updateProfile(profile)
		profile = ki9.getProfile()
		profile.displayName = "戦神☆8"
		ki9.updateProfile(profile)
		profile = ki10.getProfile()
		profile.displayName = "戦神☆9"
